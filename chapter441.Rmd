...
```{r Code41, echo=FALSE, message=FALSE, warning=FALSE}
library(MASS)
...
```{r Code42, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Weeek4, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Code43, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Code44, echo=FALSE, message=FALSE, warning=FALSE}
library(dplyr)
library(MASS)
library(corrplot)
library(tidyverse)
...
```{r Code451, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Code45, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Code46, message=FALSE, warning=FALSE, include=FALSE}
data("Boston")
library(clusterSim)
...
k_max <- 10
```
```{r Code47, echo=FALSE, message=FALSE, warning=FALSE}
